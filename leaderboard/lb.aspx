<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lb.aspx.cs" Inherits="leaderboard.lb" %>
        ...
        <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                <Columns>
                    ...
                    <asp:BoundField DataField="levels" HeaderText="Level" />
                    <asp:BoundField DataField="exp" HeaderText="EXP" />
